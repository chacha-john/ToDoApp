...
import org.example.models.Interface.InterfaceTask;
...
public class SqlTask implements InterfaceTask {
    ...
    public void add (Task task) {
        String sql = "INSERT INTO tasks (userid, name, description, createdon) VALUES (:userId, :name, :description, :createdon)";
